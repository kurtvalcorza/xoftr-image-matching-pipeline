...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    5_516_512: "XoFTR fine-tune adapter.safetensors from the tutorial run (22 tensors)",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "3385e8d5121116805d99f700aaceddbbe9760a8dd22585e55404172e1ea0d488": "upstream sibling xoftr_840.safetensors of vismatch/xoftr at d8ee7d8 (not staged)",
}
